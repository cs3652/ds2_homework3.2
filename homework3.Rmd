...
```{r}
train_weekly = Weekly[!training.data,2:3]
train_direction = Weekly$Direction[!training.data]
...
ctrl <- trainControl(method = "repeatedcv",
                     ...
                     classProbs = TRUE)
set.seed(1)
model.knn <- train(x = Weekly[training.data,2:3],
                   y = Weekly$Direction[training.data],
                   method = "knn",
